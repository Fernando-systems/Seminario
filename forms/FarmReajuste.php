            ...
            <div class="input-group-prepend">
                    ...
                    <div class="row">
                        ...
                        <div class="input-group input-group-sm mb-sm-3 col-sm-3" id="PrecioUnitEntr" hidden>
                            <div class="input-group-prepend">
                                <label class="input-group-text" for="inputPrecioUnitEntr" id="inputPrecioUnitEntr">Precio Unitario</label>
                            </div>
                            <input type="text" class="form-control" id="inputPrecioUnitEntr">
                        </div>
